...
from secret import EmailConfig, DatabaseConfig
...
SECRET_KEY = '%v%^#g9#uvi$*8#3k9f&a))sa)v_90k@i+(su4y*aed6d#z+@i'
...
# it is only for testing sending of mails, it has enabled to sent mail to console
